...
?>
    ...
    <section class="seccion contenedor">
        ...
        <div class="contenedor-anuncios">
            <div class="anuncio">
                <picture>
                    <source srcset="build/img/anuncio1.webp" type="image/web">
                    <source srcset="build/img/anuncio1.jpg" type="image/jpeg">
                    <img loading="lazy" src="build/img/anuncio1.jpg" alt="anunicio">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa de Lujo en Lago</h3>
                    <p>Casa en el lago con excelente vista al lago, acabados de lujo</p>
            ...
            <div class="anuncio">
                <picture>
                    <source srcset="build/img/anuncio2.webp" type="image/web">
                    <source srcset="build/img/anuncio2.jpg" type="image/jpeg">
                    <img loading="lazy" src="build/img/anuncio2.jpg" alt="anunicio">
                </picture>
                <div class="contenido-anuncio">
                    <h3>Casa de Lujo en Lago</h3>
                    <p>Casa en el lago con excelente vista al lago, acabados de lujo</p>
            ...
            <div class="anuncio">
                <picture>
                    <source srcset="build/img/anuncio3.webp" type="image/web">
